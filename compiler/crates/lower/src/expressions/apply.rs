...
pub const APPLY: Rule = Rule::new("apply", &[RuleCategory::Expression]);

/// The function in a function application.
pub const FUNCTION_IN_APPLY: Rule = Rule::new("function_in_apply", &[RuleCategory::Expression]);

/// The input in a function application.
pub const INPUT_IN_APPLY: Rule = Rule::new("input_in_apply", &[RuleCategory::Expression]);
